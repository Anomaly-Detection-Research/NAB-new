...
if __name__ == "__main__":
  ...
  if "TSA_AR" in args.detectors:
    from nab.detectors.TSA_AR.TSA_AR_detector import (
      TSA_ARDetector)
  if "TSA_MA" in args.detectors:
    from nab.detectors.TSA_MA.TSA_MA_detector import (
      TSA_MADetector)
  if "TSA_ARMA" in args.detectors:
    from nab.detectors.TSA_ARMA.TSA_ARMA_detector import (
      TSA_ARMADetector)
